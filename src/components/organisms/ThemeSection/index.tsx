    ...
    return (
        <S.ThemeSection>
            <S.ThemeHeader>
                ...
                <S.ThemeButton>
                    <Link href="/">전체보기</Link>
                    <Button type={"button"} color="themeBtn" onClick={handlePrev} disabled={prevButtonDisable}>
                        {prevButtonDisable ? (
                            <Image src={'/assets/svg/before_disable.svg'} alt="이전"  width="30" height="30"/>
                        ) : (
                    ...
                    <Button type={"button"} color="themeBtn" onClick={handleNext} >
                        {nextButtonDisable ? (
                            <Image src={'/assets/svg/next_disable.svg'} alt="다음"  width="30" height="30"/>
                        ) : (
                            <Image src={'/assets/svg/next.svg'} alt="다음"  width="30" height="30"/>
                        )}
                    </Button>
                </S.ThemeButton>
            </S.ThemeHeader>
